                ...
                <form onSubmit={submitHandler}>
                    ...
                    <Row>
                        <Col>
                            ...
                            <input name='diagnosis' className={classes.fullSize} />
                        </Col>
                    </Row>
                    <Row>
                        <Col>
                    ...
                    {/* <Row>
                        <Col>
                            <label>Γενική εικόνα</label>
                            <input className={classes.threeInput} />
                        </Col>
                        <Col>
                        <label>Γενική εικόνα</label>
                            <input className={classes.threeInput} />
                        ...
                        <Col>
                        <label>Γενική εικόνα</label>
                        <BMI height={bmiParams.height} weight={bmiParams.weight} />
                        </Col>
                    </Row> */}
                    <Row>
                    ...
                    <Row>
                        <Col className={classes.threeInput}><label>Όγκος Όρχεων(ml)</label><input /></Col>
                    </Row>
                    <Row>
